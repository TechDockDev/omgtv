...
const notificationDocument: OpenAPIV3.Document = {
  openapi: "3.0.3",
  info: {
    title: "Notification Service API",
    version: "1.0.0",
    description:
      "Push notifications, in-app notifications, user preferences, FCM token management, and admin campaigns.",
  },
  paths: {
    ...
    "/api/v1/notifications/push/register-token": {
      post: {
        summary: "Register FCM device token",
        description:
          "Register or update a Firebase Cloud Messaging device token for push notifications.",
        tags: ["Notification Service"],
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
    ...
    "/api/v1/notifications/push/unregister-token": {
      delete: {
        summary: "Unregister FCM device token",
        description: "Remove a previously registered FCM device token.",
        tags: ["Notification Service"],
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: {
                ...
                required: ["token"],
                properties: {
                  token: { type: "string", description: "The FCM token to remove." },
                },
              },
            },
          },
    ...
    "/api/v1/notifications/admin/send": {
      post: {
        ...
        description: "Send a push or in-app notification to a specific user (admin only).",
        tags: ["Notification Service — Admin"],
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
            "application/json": {
              schema: {
                $ref: "#/components/schemas/AdminSendNotificationRequest",
              },
            },
          },
        },
    ...
    "/api/v1/notifications/admin/broadcast": {
      post: {
        ...
        description: "Send a push notification to all subscribed users via FCM topic (admin only).",
        tags: ["Notification Service — Admin"],
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
    ...
    "/api/v1/notifications/admin/stats": {
      get: {
        ...
        description: "Get high-level notification counts (total, pending, sent, failed, read).",
        tags: ["Notification Service — Admin"],
        security: [{ bearerAuth: [] }],
        responses: {
          "200": {
    ...
    "/api/v1/notifications/admin/campaigns": {
      post: {
      ...
      get: {
        ...
        description: "Retrieve a paginated list of campaigns (admin only).",
        tags: ["Notification Service — Admin"],
        security: [{ bearerAuth: [] }],
        parameters: [
          {
    ...
    "/api/v1/notifications/admin/campaigns/{id}": {
      get: {
        summary: "Get campaign details",
        description: "Retrieve details for a specific campaign (admin only).",
        tags: ["Notification Service — Admin"],
        security: [{ bearerAuth: [] }],
        parameters: [
          {
    ...
    "/api/v1/notifications/admin/campaigns/{id}/execute": {
      post: {
        summary: "Execute campaign",
        description: "Manually trigger an existing campaign to send notifications (admin only).",
        tags: ["Notification Service — Admin"],
        security: [{ bearerAuth: [] }],
        parameters: [
          {
    ...
    schemas: {
      ...
      NotificationPreference: {
        ...
        properties: {
          ...
          allowMarketing: { type: "boolean" },
          allowTransactional: { type: "boolean" },
      ...
      RegisterTokenRequest: {
        ...
        properties: {
          userId: { type: "string", format: "uuid" },
          token: { type: "string", description: "FCM device push token." },
...
export function getGatewayServiceDocuments(): ServiceDocument[] {
  return [
    ...
    {
      service: findServiceByName("notification"),
